...
const mockTrades = [
  { id: 1, date: '2026-06-05', type: '買入', symbol: '2330', name: '台積電', shares: 10,  price: 580,  amount: 5800, fee: 29 },
  { id: 2, date: '2026-06-03', type: '賣出', symbol: '2454', name: '聯發科', shares: 5,   price: 1120, amount: 5600, fee: 84 },
  { id: 3, date: '2026-06-01', type: '買入', symbol: '2317', name: '鴻海',   shares: 20,  price: 105,  amount: 2100, fee: 11 },
  { id: 4, date: '2026-05-28', type: '買入', symbol: '2882', name: '國泰金', shares: 50,  price: 42,   amount: 2100, fee: 11 },
  { id: 5, date: '2026-05-25', type: '賣出', symbol: '2412', name: '中華電', shares: 30,  price: 118,  amount: 3540, fee: 53 },
  { id: 6, date: '2026-05-20', type: '買入', symbol: '2330', name: '台積電', shares: 15,  price: 520,  amount: 7800, fee: 39 },
]

const FILTER_TYPES = ['全部', '買入', '賣出']
...
export default function TradesPage() {
  ...
  const handleExportCSV = () => {
    const headers = ['日期', '類型', '股票代號', '股票名稱', '股數', '價格', '金額', '手續費']
    const rows = filteredTrades.map((t) => [t.date, t.type, t.symbol, t.name, t.shares, t.price, t.amount, t.fee])
                ...
                <tr key={trade.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 px-6">
                    <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${
                      trade.type === '買入' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                    }`}>
                      {trade.type}
                    </span>
                  </td>
